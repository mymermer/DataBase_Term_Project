LOAD DATA INFILE 't/CUP_POINTS.csv' INTO TABLE CUP_POINTS FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS  (
    game_point_id,
    game_player_id,
    game_play_id,
    game_id,
...
LOAD DATA INFILE 't/LIG_POINTS.csv' INTO TABLE LIG_POINTS FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_point_id,
    game_player_id,
    game_play_id,
    game_id,
...
LOAD DATA INFILE 't/CUP_TEAMS.csv' INTO TABLE CUP_TEAMS FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 LINES (
    season_team_id,
    games_played,
    minutes_played,
    points,
...
LOAD DATA INFILE 't/LIG_TEAMS.csv' INTO TABLE LIG_TEAMS FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 LINES (
    season_team_id,
    games_played,
    minutes_played,
    points,
...
LOAD DATA INFILE 't/CUP_COMPARISON.csv' INTO TABLE CUP_COMPARISON FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_id,
    game,
    round_of_game,
    phase,
...
LOAD DATA INFILE 't/LIG_COMPARISON.csv' INTO TABLE LIG_COMPARISON FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_id,
    game,
    round_of_game,
    phase,
...
LOAD DATA INFILE 't/CUP_HEADER.csv' INTO TABLE CUP_HEADER FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_id,
    game,
    date_of_game,
    time_of_game,
...
LOAD DATA INFILE 't/LIG_HEADER.csv' INTO TABLE LIG_HEADER FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_id,
    game,
    date_of_game,
    time_of_game,
...
LOAD DATA INFILE 't/CUP_PLAY_BY_PLAY.csv' INTO TABLE CUP_PLAY_BY_PLAY FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_play_id,
    game_player_id,
    game_point_id,
    game_id,
...
LOAD DATA INFILE 't/LIG_PLAY_BY_PLAY.csv' INTO TABLE LIG_PLAY_BY_PLAY FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_play_id,
    game_player_id,
    game_point_id,
    game_id,
...
LOAD DATA INFILE 't/CUP_BOX_SCORE.csv' INTO TABLE CUP_BOX_SCORE FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_player_id,
    game_id,
    game,
    round_of_game,
...
LOAD DATA INFILE 't/LIG_BOX_SCORE.csv' INTO TABLE LIG_BOX_SCORE FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    game_player_id,
    game_id,
    game,
    round_of_game,
...
LOAD DATA INFILE 't/CUP_PLAYERS.csv' INTO TABLE CUP_PLAYERS FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    season_player_id,
    season_team_id,
    player,
    games_played,
...
LOAD DATA INFILE 't/LIG_PLAYERS.csv' INTO TABLE LIG_PLAYERS FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"'  LINES TERMINATED BY '\n' IGNORE 1 LINES (
    season_player_id,
    season_team_id,
    player,
    games_played,
...
LOAD DATA INFILE 't/unique_teams_with_logos.csv' INTO TABLE teams FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 LINES (
    abbreviation,
    full_name,
    logo_url
);
